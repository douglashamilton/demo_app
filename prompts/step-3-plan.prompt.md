...
Read the PRD and TDD both located in the `../docs/` folder. If either document does not exist, inform the user that the document is missing and request that they complete the previous steps first.
